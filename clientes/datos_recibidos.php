...
echo "<p><strong>Apellido:</strong> $clienteApellido</p>";
echo "<p><strong>DNI:</strong> $clienteDni</p>";
echo "<p><strong>Teléfono:</strong> $clienteTelefono</p>";
echo "<p><strong>Correo electrónico:</strong> $clienteMail</p>";

$sql = "INSERT INTO clientes 
        (clienteNombre, clienteApellido, clienteDni, clienteTelefono, clienteMail) 
        VALUES ('$clienteNombre', '$clienteApellido', '$clienteDni', '$clienteTelefono', '$clienteMail')";
...
echo "<p><a href='#' id='cliente-link'>Ver lista de clientes</a></p> ";
?>
