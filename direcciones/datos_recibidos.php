...
$direccionProvincia = $_POST["direccionProvincia"];
$direccionCiudad = $_POST["direccionCiudad"];
$direccionCodigopostal = $_POST["direccionCodigopostal"];
$direccionBarrio = $_POST["direccionBarrio"];
$direccionCallenombre = $_POST["direccionCallenombre"];
$direccionCallenumero = $_POST["direccionCallenumero"];
$direccionDeptonumero = $_POST["direccionDeptonumero"];
$direccionDetalles = $_POST["direccionDetalles"];

echo "<h2>Detalles del formulario de direcciones:</h2>";
echo "<p><strong>País:</strong> $direccionPais</p>";
echo "<p><strong>Provincia:</strong> $direccionProvincia</p>";
echo "<p><strong>Ciudad:</strong> $direccionCiudad</p>";
echo "<p><strong>Código Postal:</strong> $direccionCodigopostal</p>";
echo "<p><strong>Barrio:</strong> $direccionBarrio</p>";
echo "<p><strong>Calle:</strong> $direccionCallenombre</p>";
echo "<p><strong>Número:</strong> $direccionCallenumero</p>";
echo "<p><strong>Departamento:</strong> $direccionDeptonumero</p>";
echo "<p><strong>Detalles:</strong> $direccionDetalles</p>";

$sql = "INSERT INTO direcciones 
        (direccionPais, direccionProvincia, direccionCiudad, direccionCodigopostal, direccionBarrio, direccionCallenombre, direccionCallenumero, direccionDeptonumero, direccionDetalles) 
        VALUES ('$direccionPais', '$direccionProvincia', '$direccionCiudad', '$direccionCodigopostal', '$direccionBarrio', '$direccionCallenombre', '$direccionCallenumero', '$direccionDeptonumero', '$direccionDetalles')";
...
echo "<p><a href='#' id='direccion-link'>Ver lista de direcciones</a></p> ";
?>
