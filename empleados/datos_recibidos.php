...
$empleadoDni = $_POST["empleadoDni"];
$empleado_direccion = $_POST["empleado_direccion"];
$empleadoTelefono = $_POST["empleadoTelefono"];
$empleadoMail = $_POST["empleadoMail"];

echo "<h2>Detalles del formulario de empleados:</h2>";
echo "<p><strong>Nombre:</strong> $empleadoNombre</p>";
echo "<p><strong>Apellido:</strong> $empleadoApellido</p>";
echo "<p><strong>DNI:</strong> $empleadoDni</p>";
echo "<p><strong>Dirección:</strong> $empleado_direccion</p>";
echo "<p><strong>Teléfono:</strong> $empleadoTelefono</p>";
echo "<p><strong>Correo electrónico:</strong> $empleadoMail</p>";

$sql = "INSERT INTO empleados
        (empleadoNombre, empleadoApellido, empleadoDni, empleado_direccion, empleadoTelefono, empleadoMail) 
        VALUES ('$empleadoNombre', '$empleadoApellido', '$empleadoDni', '$empleado_direccion', '$empleadoTelefono', '$empleadoMail')";
...
echo "<p><a href='#' id='empleado-link'>Ver lista de empleados</a></p> ";
?>
